...
if ( choice == 2 ) then
  ...
  if ( choice_specific /= 1 .and. choice_specific /= 2 ) then
   ...
   write ( * , * ) "input the orbital you want: s p d t2g eg px py pz dxy dyz dxz dx2-y2 dz2 "
  ...
  do i = 1 , number_of_steps
   ...
   do i = 1 , number_of_steps
    ...
    if ( choice_polarization == 1 ) then
      ...
      else if ( orbital == 'd' ) then

        dos_up = n9+n11+n13+n15+n17
       
        dos_down = n10+n12+n14+n16+n18

      else if ( orbital == 't2g') then

        dos_up = n9+n11+n15

        dos_down = n10+n12+n15

      else if (orbital == 'eg' ) then
