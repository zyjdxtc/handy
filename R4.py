...
#generate R4 rotation in Pbnm symmetry
...
print 0.5+d,     0.5-d,     '0.000  T T T'
print 0.5-d,     -0.5+d,    '0.000  T T T'

print 0.5,      0.0,       0.5+d,  'T T T'
print 1.000,     -0.5,     0.5-d, 'T T T'
print 1.000,     0.5,      0.5+d, 'T T T'
print 1.5,     0.0,       0.5-d, 'T T T'

print 0.5-d,     0.5+d,     '1.000  T T T'
print 0.5+d,     -d-0.5,    '1.000  T T T'

print 0.5,     0.0,       1.5-d,  'T T T'
print 1.0,       -0.5,    1.5+d,  'T T T'
print 1.0,       0.5,     1.5-d,  'T T T'
print 1.5,     0.0,       1.5+d,  'T T T' 
