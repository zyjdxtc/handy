...
def generatePOS(coord_undis,pos_undis,coord_dis,pos_dis,n,new_scale,fhead):
    n=int(n)
    diff=(pos_dis-pos_undis)/n*new_scale
    coorddiff=(coord_dis-coord_undis)/n*new_scale
    p,q=pos_dis.shape
...
if __name__=='__main__':
    ...
    generatePOS(coordundis,posundis,coorddis,posdis,N,new_scale,fhead)
    print '------------------------------------------------'
    print posundis
    print '------------------------------------------------'
    print posdis
